        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Discover a world of adventure and endless fun with our premium toy
              car selection.
            </h1>
            <p className="mb-8 leading-relaxed">
              Race into action with our ultra-realistic toy cars, designed for
              speed and precision.Fuel your child's passion for cars with our
              carefully curated selection of the latest toy car models.
            </p>
            <div className="flex w-full md:justify-start justify-center items-end">
              <Link to={`/allToys`}>
                <button className="inline-flex text-white bgColor  border-0 py-2 px-6 focus:outline-none  rounded text-lg mb-5">
                  Shop Now
                </button>
              </Link>
            </div>
